                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($user->status_pembayaran)
                                                                <form
                                                                    action="{{ url('dashboard/admin/unverify', $user->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <button type="submit"
                                                            ...
                                                            @else
                                                                <form
                                                                    action="{{ url('dashboard/admin/verify', $user->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <button type="submit"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ url('dashboard/admin', $user->id) }}"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="password">password (untuk password
                                                                                jika
