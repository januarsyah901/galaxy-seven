...
<!--  </head>-->
<!--  <body>-->
      <h2 class="section-title">KOMPETISI POSTER</h2>
  <h4 class="head">Tema</h4>
  <p>“Indonesia Culture”</p>
  <br>
  <h4 class="head">Timeline Pelaksanaan</h4>
    ...
    <h4 class="head">Persyaratan</h4>
      <ol start="1" class="list">
        ...
        <li>Peserta lomba berupa individu</li>
        <li>Tiap peserta maksimal mengirimkan 1 karya</li>https://www.tiktok.com/@galaxy.olympiad
        <li>Memfollow akun Instagram dan tiktok <b><a href="https://instagram.com/mai.amanatulummah.pacet">@mai.amanatulummah.pacet</a></b> dan <b><a href="https://instagram.com/galaxy.olympiad">@galaxy.olympiad</a></b></li>
        <li>Mensubscribe akun youtube <b><a href="https://www.youtube.com/channel/UCu7xkBB8LZdrluR5ow1W27A">MAI PRODUCTION</a></b></li>
        <li>Men-<i>share</i> pamflet galaxy ke 3 grup belajar WA / Telegram / Line</li>
      </ol>
    <br>
    ...
    <h4 class="head">Ketentuan Karya</h4>
      <ol start="1" class="list">
        ...
        <li>Karya poster yang dikirim dan diikutsertakan dalam lomba tidak mengandung unsur SARA, pornografi, kekerasan dan apapun yang bertentangan dengan hukum di Indonesia</li>
     ...
     <p>Peserta mengunggah hasil karya Poster pada akun Instagram peserta</p>
     </br>
     ...
     <h6 class="subhead">Data yang dikirimkan di google form :</h6>
      <ol start="1" class="list">
      ...
      <ol start="1" class="list">
        ...
        <li>Akan dipilih 10 karya untuk masuk ke babak final.</li>
        <li>Bagi 10 karya yang lolos akan di upload di instagram <b><a href="https://instagram.com/galaxy.olympiad">@galaxy.olympiad</a></b></li>
